      ...
      <div className='bg-[color:var(--color-darkest)] rounded-[20px] py-5.5 px-5'>
        <div className='flex gap-[7px] '>
                    ...
                    <div className='flex justify-around'>
                        <div className='bg-[#B1ED0042] py-[13px] cursor-pointer px-[114px] gap-[3px] rounded-[10px] border border-[#B1ED00]'>
                            <Icon icon="mynaui:sun" width="26" height="26" className='text-white' />
                            <p className='text-xs text-white'>Light</p>
                        </div>
                          <div className='bg-white/20 py-[13px] cursor-pointer px-[114px] gap-[3px] rounded-[10px] '>
                            <Icon icon="solar:moon-line-duotone" width="21" height="21" className='text-white' />
                            <p className='text-xs text-white'>Dark</p>
                        </div>
                           <div className='bg-[#0D0D0D] cursor-pointer py-[13px] gap-[3px] px-[114px] rounded-[10px] border border-white/20'>
