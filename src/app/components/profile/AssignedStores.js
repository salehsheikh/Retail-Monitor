  ...
  return (
    ...
    <div className='bg-[color:var(--color-darkest)] rounded-[20px] py-4 px-5'>
        ...
        <div className='grid grid-cols-2 gap-x-7 gap-y-2.5'>
           <button className='rounded-[20px] border border-[#B1ED00] text-xs text-white bg-[#B1ED00]/26 py-[7px] px-28'>
        ...
        <div className='py-[7px] px-[9px] bg-[#6C6BDB1A] rounded-[10px]'>
            ...
            <p className='text-xs text-[#6C6BDB] pt-[9px] pb-4.5 pl-6'>You are monitoring 3 stores</p>
            <div className='text-xs text-white/50 flex gap-3 pl-6'>
                <div className='py-1 px-2.5 rounded-[10px] border border-white/50'>Downtown Mall Store-15</div>
                <div  className='py-1 px-2.5 rounded-[10px] border border-white/50'>Downtown Mall Store-15</div>
                <div  className='py-1 px-2.5 rounded-[10px] border border-white/50'>Downtown Mall Store-15</div>
            </div>
